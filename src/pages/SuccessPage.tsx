...
export function SuccessPage({ onBackToHome, onDownloadTicket }: SuccessPageProps) {
        ...
        <div className='lg:col-span-3 hidden lg:block'>
          <div className='sticky top-8 space-y-8'>
            ...
            <div className='flex gap-4 relative'>
              ...
              <div className='pt-1'>
                <div className='text-sm tracking-wide uppercase mb-1 text-nature-text-primary font-bold'>Success</div>
              ...
              <div className='space-y-6'>
                ...
                <div className='flex items-start gap-4'>
                  ...
                  <div className='flex-grow'>
                    ...
                    <div className='font-mono text-sm text-nature-text-secondary'>09:30 AM - 10:15 AM</div>
                  </div>
                </div>
                ...
                <div className='flex items-start gap-4'>
                  ...
                  <div className='flex-grow'>
                    ...
                    <div className='font-mono text-sm text-nature-text-secondary'>Senior Stylist</div>
                  </div>
                </div>
