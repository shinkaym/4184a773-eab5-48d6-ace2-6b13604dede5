...
export function AppointmentSelectionPage({ onBack, onConfirm }: AppointmentSelectionPageProps) {
  return (
            ...
            <div className='space-y-8 mb-12'>
                ...
                <div className='flex-grow'>
                  <div className='flex items-start justify-between'>
                    <div>
                      ...
                      <p className='font-mono text-sm text-nature-text-secondary'>09:30 AM - 10:15 AM</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className='flex items-start gap-6'>
                ...
                <div className='flex-grow'>
                  <div className='flex items-start justify-between'>
                    <div>
                      <h3 className='font-bold text-lg uppercase mb-1'>Sarah M.</h3>
                      <p className='font-mono text-sm text-nature-text-secondary'>Senior Stylist</p>
                    </div>
                  </div>
                </div>
              </div>
